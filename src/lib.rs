...
use syn::{
    spanned::Spanned, AttributeArgs, Block, FieldPat, FnArg, Ident, ItemFn, Lit, LitInt, Meta,
    MetaList, MetaNameValue, NestedMeta, Pat, PatIdent, PatReference, PatStruct, PatTuple,
    PatTupleStruct, PatType, Signature,
};
...
pub fn instrument(args: TokenStream, item: TokenStream) -> TokenStream {
    ...
    let block = instrument_block(block);
...
fn instrument_block(block: &Block) -> impl ToTokens {
    quote!({})
}
